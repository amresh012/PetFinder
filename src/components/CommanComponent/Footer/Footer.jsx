  ...
  return (
    <div className="footer flex flex-col items-center gap-12 justify-center ">
      ...
      <div className="Newsletter flex flex-col w-full items-center  justify-center gap-4 bg-slate-950 p-4  ">
        ...
        <div className="  flex  items-center justify-center rounded-l-full w-1/2">
          <input
            ...
            required
            className="h-max w-full lg:w-1/2 p-2  rounded-l-full outline-none "
          ></input>
          <button className=" bg-blue-500 text-white  font-bold p-2 rounded-r-full  active:scale-95 relative">
            Subscribe
          </button>
        </div>
      </div>
      <div className="wrapper flex  flex-col lg:flex-row justify-start items-start px-4 lg:justify-center lg:items-center w-full">
      ...
      <div className="copyright  flex flex-col items-center justify-center">
        ...
        <div className="icon  gap-4 backdrop-blur-lg cursor-pointer text-blue-500    flex justify-around items-center  p-2 m-4 rounded-md">
